# SGI 2022/2023 - Checkers (TP3)

![Picking a piece](./readme_assets/tp3_pick_piece.png)

## How to run and play

Please check the user manual at [./docs/user_manual.pdf](./docs/Manual.pdf) for a detailed explanation on how to run and play the game. You can also play the game online at [https://bdmendes.github.io/feup-sgi-checkers](https://bdmendes.github.io/feup-sgi-checkers).

> NOTE: This is an academic project, done in the context of Interactive Graphics Systems @ M.EIC, FEUP. Rely on this implementation at your own risk.
